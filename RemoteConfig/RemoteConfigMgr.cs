...
namespace Hunter
{
    ...
    public class RemoteConfigMgr : TSingleton<RemoteConfigMgr>
    {
        ...
        private bool m_IsRemoteAdConfigPullSuccess = false;
        ...
        public void StartChecker(Action listener)
        {
            ...
            DataAnalysisMgr.S.CheckRemoteConfig();                
        }
        ...
        protected void UpdateRemoteAdConfig()
        {            
        ...
        public bool CheckNeedUpdateConfigFile()
        {
            ...
            if(m_IsRemoteAdConfigPullSuccess)
            {
                return false;
            }
        ...
        protected string GetAssetUrl(string path)
        {
            ...
            {
                return string.Format("http://35.201.102.198/{0}/{1}", SDKConfig.S.bundleID.Trim(), path);
            }
            else
            {
                return string.Format("http://35.201.102.198/{0}/{1}/{2}", SDKConfig.S.bundleID.Trim(), AppConfig.S.resUpdateVersion.Trim(), path);
            }
