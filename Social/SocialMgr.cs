...
namespace Hunter
{
    public class SocialMgr : TSingleton<SocialMgr>, ISocialAdapter
    {
        ...
        public const string ANDROID_FACEBOOK_PACKAGE = "com.facebook.katana";
        public const string ANDROID_INSTAGRAM_PACKAGE = "com.instagram.android";
        public const string ANDROID_TWITTER_PACKAGE = "com.twitter.android";
        ...
        public void ShareTextWithURL(string title, string msg, string url)
        {
            ...
            DataAnalysisMgr.S.CustomEventWithAppsflyer(DataAnalysisDefine.SHARE_POSTCARD);
        }

        public void ShareTextWithURLByPackage(string title, string msg, string url, string package)
        {
            m_Adapter.ShareTextWithURLByPackage(title, msg, url, package);
        ...
        public void OpenMarketDownloadPage(string identifyer)
        {
            ...
            DataAnalysisMgr.S.CustomEventWithAppsflyer(DataAnalysisDefine.CROSS_EXT, identifyer);
        }
