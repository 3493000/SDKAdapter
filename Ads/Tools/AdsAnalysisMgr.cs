...
namespace Hunter
{
    public class AdsAnalysisDefine
    {
        ...
        public static string LAST_VIDEO_SHOW_TIME = "video_showtime";
	...
	{
	    public static readonly int defaultInterVal = -1;//默认广告关闭
        ...
        private int m_LastShowVideoTime;

        public int lastVideoShowTime
        {
            get { return m_LastShowVideoTime; }
            set
            {
                m_LastShowVideoTime = value;
                PlayerPrefs.SetInt(AdsAnalysisDefine.LAST_VIDEO_SHOW_TIME, value);
            }
        }

        public int lastShowVideoPassTime
        {
            get
            {
                return m_PlayMinTime - lastVideoShowTime;
            }
        }
        ...
        public override void OnSingletonInit()
	    {
            ...
            m_LastShowVideoTime = PlayerPrefs.GetInt(AdsAnalysisDefine.LAST_VIDEO_SHOW_TIME, 0);
	    ...
	    public void AddRewardShowCount()
	    {
            ...
            lastVideoShowTime = m_PlayMinTime;
	        CalInterval();
	    }
        ...
        void ParseWeightData()
	    {
	        ...
	        m_SecInterTime = TDRemoteConfigTable.QueryInt(AdsAnalysisDefine.SEC_INTER_TIME, -99);
