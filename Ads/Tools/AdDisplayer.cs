    ...
    public class AdDisplayer : AbstractPanel, IAdInterfaceEventListener
    {
        public class AdDisplayerBuilder
        {
            ...
            public void CustomAdTag(string state)
            {
                ...
                DataAnalysisMgr.S.CustomEventWithAppsflyer(DataAnalysisDefine.AD_DISPLAY, string.Format("{0}-{1}", m_AdTag, state));
            }
        ...
        protected override void OnPanelOpen(params object[] args)
        {
            ...
            DataAnalysisMgr.S.CustomEventWithAppsflyer(DataAnalysisDefine.W_AD_TRIGGER, null,
                new Dictionary<string, string>(){{ "item_id", "1"} });
        ...
        public void OnOffwallCloseEvent(string rewardId, double currencyCount)
        {
