...
namespace GoogleMobileAds.Editor
{
    ...
    {
        private const string MobileAdsSettingsDir = "Assets/SDKAdapter/Ads/GoogleMobileAds";

        private const string MobileAdsSettingsResDir = "Assets/SDKAdapter/Ads/GoogleMobileAds/Resources";

        private const string MobileAdsSettingsFile =
            "Assets/SDKAdapter/Ads/GoogleMobileAds/Resources/GoogleMobileAdsSettings.asset";
